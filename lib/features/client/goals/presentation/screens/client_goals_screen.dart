...
import 'client_goal_detail_screen.dart';

/// Provider for client goals list
final clientGoalsProvider = StreamProvider<List<Goal>>((ref) async* {
  ...
  yield* goalRepo.watchClientGoals(user.id);
});

class ClientGoalsScreen extends ConsumerWidget {
  const ClientGoalsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final goalsAsync = ref.watch(clientGoalsProvider);
      ...
      body: goalsAsync.when(
        data: (goals) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Your coach will set goals for you here',
          ...
          return RefreshIndicator(
            onRefresh: () async {
              ref.invalidate(clientGoalsProvider);
            },
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _GoalCard(
                  goal: goal,
                  onTap: () {
                    context.push('/client/goals/${goal.id}');
                  },
                  isDark: isDark,
                );
              },
